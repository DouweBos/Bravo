...
**Bravo** is an internal fork of [Maestro](https://github.com/mobile-dev-inc/Maestro). It exists so we can ship the features we need **ahead** of upstream accepting our PRs, and run a full multi-platform Maestro runner internally without waiting on the upstream merge queue.
